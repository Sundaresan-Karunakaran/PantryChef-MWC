...
public class ReceiptScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Pantry repository'yi başlat
        pantryRepository = new PantryRepository(getApplication());
    ...
    private void processWithGemini(Bitmap bitmap) {
        ...
        parser.parseReceipt(bitmap)
                .thenAccept(result -> {
                    // 1) Pantry veritabanına ekle
                    pantryRepository.addItemsFromText(result, true);
